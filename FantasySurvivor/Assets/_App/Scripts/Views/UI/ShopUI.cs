...
public class ShopUI : View<GameApp>
{
    ...
    protected override void OnViewInit()
    {
        ...
        item.Init(itemController.GetDataItem(ItemId.Ring, ItemRank.Normal), 1000,this,0);
        
        Instantiate(_prefabItemSlotUI, _containerDaily).TryGetComponent(out ItemSlotUIShop item1);
        item1.Init(itemController.GetDataItem(ItemId.Armor, ItemRank.Normal), 2000,this,0);
        
        Instantiate(_prefabItemSlotUI, _containerDaily).TryGetComponent(out ItemSlotUIShop item2);
        item2.Init(itemController.GetDataItem(ItemId.Axe, ItemRank.Normal), 3000,this,0);
    }
}
