...
public class LoseGamePopup : View<GameApp>, IPopup
{
    ...
    private void SetAnimOpen()
    {
        ...
        _leftArrow.transform.localPosition = new Vector3(-750, 300);
        _rightArrow.transform.localPosition = new Vector3(750, 300);
        ...
        _sequence
            ...
            .Join(_leftArrow.transform.DOLocalMove(new Vector3(-375, 300), duration))
            .Join(_rightArrow.transform.DOLocalMove(new Vector3(375, 300), duration))
