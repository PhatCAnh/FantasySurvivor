...
namespace FantasySurvivor
{
	public class MonsterStat
	{
		...
		public StatInt maxHealth = new();
		public StatInt attackDamage = new();
		public StatFloat attackSpeed = new();
		public StatFloat attackRange = new();
		public StatInt exp = new();

		public MonsterStat(float moveSpeed, int health, int attackDamage, float attackSpeed, float attackRange, int exp)
		{
